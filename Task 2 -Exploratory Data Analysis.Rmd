...
This is the [Week 2 Milestone report](https://www.coursera.org/learn/data-science-project/supplement/BePVz/task-2-exploratory-data-analysis) for the Coursera Data Science Capstone Project.  
...
To determine how many unique words are needed to cover 50% and 90% of all word instances in the dataset, we need to:
 ...
 - Use word frequency table from the corpus.
...
Then to cover   
50% we need **`r words_50`** words.  
90% we need **`r words_90`** words.
...
If a word does not appear in the dictionary, embeddings can find a similar known word.
`word2vec:read.wordvectors(),nearest_neighbors()`

##### 4. Spelling Normalization (Fuzzy Matching)!
Typos and misspellings reduce coverage. Use fuzzy matching to map misspelled words to known words.
